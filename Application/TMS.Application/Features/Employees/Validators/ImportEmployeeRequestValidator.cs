...
public class ImportEmployeeRequestValidator :  AbstractValidator<List<ImportEmployeeRequest>>
{
    public ImportEmployeeRequestValidator()
    {
        RuleLevelCascadeMode = CascadeMode.Stop;
        
        RuleForEach(employees => employees)
            .ChildRules(employee =>
            {
                employee.RuleFor(x => x.Name)
                ...
                employee.RuleFor(x => x.DateOfBirth)
                ...
                employee.RuleFor(x => x.EmployeeType)
                    .Must(name => !string.IsNullOrWhiteSpace(name))
                ...
                employee.RuleFor(x => x.StartDate)
